        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 bg-primary-500 hover:bg-primary-600 rounded-xl font-semibold transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 bg-emerald-500 hover:bg-emerald-600 rounded-xl font-semibold transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 bg-white/10 hover:bg-white/20 rounded-xl font-semibold transition-colors"
            >
